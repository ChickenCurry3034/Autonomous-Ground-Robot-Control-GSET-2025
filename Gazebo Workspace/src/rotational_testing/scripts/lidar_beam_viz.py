...
#NOTE: optional but very useful for visualizing points seen by TurtleBot3 Burger
    #after initializing ros-master, before initializing gazebo, run "rosrun <name of catkin ws> lidar_beam_viz.py"
    #EXAMPLE: in the case of this workspace, it would be --> "rosrun lidar_testing lidar_beam_viz.py"
